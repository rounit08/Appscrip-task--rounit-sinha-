...
import upIcon from "@/assets/icons/go-up.png";
    ...
    <footer className={`${styles.container}`}>
      <div className={styles.top}>
        ...
        <div className={styles.topRight}>
          ...
          <h1 className={robotoBold.className} style={{ marginTop: 10 }}>
            CURRENCY
          </h1>
      ...
      <div className={styles.middle}>
        <div className={styles.middleLeft}>
          ...
          >
            ...
            {accordionState.middle ? (
              <Image
                src={upIcon}
                alt="Up Arrow"
                style={{ background: "white", height: 20, width: 20 }}
              />
            ) : (
              <Image
                src={downIcon}
          ...
          <div
            className={`${styles.accordionContent} ${
              accordionState.left ? styles.show : ""
            }`}
          >
        ...
        <div className={styles.middleMiddle}>
          ...
          <div
            className={`${styles.accordionContent} ${
              accordionState.middle ? styles.show : ""
            }`}
          >
            <ul className={roboto.className}>
        ...
        <div className={styles.middleRight}>
          <div
            className={`${styles.accordionContent} ${
              accordionState.right ? styles.show : ""
            }`}
          >
